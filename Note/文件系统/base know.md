1. [[#磁盘IO耗时|磁盘IO耗时]]
	1. [[#磁盘IO耗时#操作系统如何降低随机读写的性能|操作系统如何降低随机读写的性能]]
1. [[#文件系统|文件系统]]
		1. [[#操作系统如何降低随机读写的性能#文件和目录创建所需资源|文件和目录创建所需资源]]
	1. [[#文件系统#linux IO栈|linux IO栈]]
		1. [[#linux IO栈#IO引擎 - 用户层lib库|IO引擎 - 用户层lib库]]
		1. [[#linux IO栈#VFS文件映射系统|VFS文件映射系统]]
		1. [[#linux IO栈#PageCache|PageCache]]
		1. [[#linux IO栈#文件系统|文件系统]]
		1. [[#linux IO栈#通用块层|通用块层]]
		1. [[#linux IO栈#IO调度层|IO调度层]]
![[硬盘.png]]
